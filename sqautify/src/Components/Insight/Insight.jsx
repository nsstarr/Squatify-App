...
const Insight = () => {
  ...
  useEffect(() => {
    const getStats = async function () {
      ...
      let squatsThisWeekAverage = Math.floor(squatsThisWeekTotal / data.length, 2);
  ...
  return (
    <InsightRow>
      ...
      <InsightElement title="Squats this week: total" number={stats.squatsThisWeekTotal} />
      <InsightElement title="Squats this week: average" number={stats.squatsThisWeekAverage} />
    </InsightRow>
  );
};
//Comment
